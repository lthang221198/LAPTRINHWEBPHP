...
<body>
    ...
    <div class="container">
        ...
        <h3 class="flash" style="text-align:center;font-size:40px;color:cornflowerblue">Danh sách sản phẩm được tìm thấy </h3>
        <div class="row">
            <?php
            ...
            if ($s) {
                ...
                // printf("Result set has %d rows.\n",$rowcount);
                 if ($rowcount) {
                    ...
                    {
                        alert("Không tìm thấy sản phẩm.Xin vui lòng nhập lại!");
                    }
